...
func ProvideAdminHandlers(
	...
	wishTeamHandler *admin.WishTeamHandler,
	poolRunwayHandler *admin.PoolRunwayHandler,
	...
	return &AdminHandlers{
		...
		WishTeam: wishTeamHandler,
		PoolRunway: poolRunwayHandler,
		Group:                  groupHandler,
...
var ProviderSet = wire.NewSet(
	...
	admin.NewWishTeamHandler,
	admin.NewPoolRunwayHandler,
	admin.NewCodexTurnStateHandler,

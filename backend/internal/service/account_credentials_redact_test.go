...
func TestIsSensitiveCredentialKey(t *testing.T) {
	...
	require.True(t, IsSensitiveCredentialKey("kiro_rs_admin_key"))
	require.True(t, IsSensitiveCredentialKey("kiro_admin_key"))
	require.True(t, IsSensitiveCredentialKey("admin_key"))

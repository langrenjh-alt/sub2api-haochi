...
func init() {
	...
	// groupDescBurstModeEnabled is the schema descriptor for burst_mode_enabled field.
	groupDescBurstModeEnabled := groupFields[8].Descriptor()
	// group.DefaultBurstModeEnabled holds the default value on creation for the burst_mode_enabled field.
	group.DefaultBurstModeEnabled = groupDescBurstModeEnabled.Default.(bool)
	// groupDescBurstModeThresholdPercent is the schema descriptor for burst_mode_threshold_percent field.
	groupDescBurstModeThresholdPercent := groupFields[9].Descriptor()
	// group.DefaultBurstModeThresholdPercent holds the default value on creation for the burst_mode_threshold_percent field.
	group.DefaultBurstModeThresholdPercent = groupDescBurstModeThresholdPercent.Default.(int)
	// group.BurstModeThresholdPercentValidator is a validator for the "burst_mode_threshold_percent" field. It is called by the builders before save.
	group.BurstModeThresholdPercentValidator = func() func(int) error {
		validators := groupDescBurstModeThresholdPercent.Validators
		fns := [...]func(int) error{
			validators[0].(func(int) error),
			validators[1].(func(int) error),
		}
		return func(burst_mode_threshold_percent int) error {
			for _, fn := range fns {
				if err := fn(burst_mode_threshold_percent); err != nil {
					return err
				}
			}
			return nil
	...
	// groupDescBurstMode429RetryCount is the schema descriptor for burst_mode_429_retry_count field.
	groupDescBurstMode429RetryCount := groupFields[10].Descriptor()
	// group.DefaultBurstMode429RetryCount holds the default value on creation for the burst_mode_429_retry_count field.
	group.DefaultBurstMode429RetryCount = groupDescBurstMode429RetryCount.Default.(int)
	// group.BurstMode429RetryCountValidator is a validator for the "burst_mode_429_retry_count" field. It is called by the builders before save.
	group.BurstMode429RetryCountValidator = func() func(int) error {
		validators := groupDescBurstMode429RetryCount.Validators
		fns := [...]func(int) error{
			validators[0].(func(int) error),
			validators[1].(func(int) error),
		}
		return func(burst_mode_429_retry_count int) error {
			for _, fn := range fns {
				if err := fn(burst_mode_429_retry_count); err != nil {
					return err
				}
			}
			return nil
	...
	// groupDescBurstModeHighUsageEnabled is the schema descriptor for burst_mode_high_usage_enabled field.
	groupDescBurstModeHighUsageEnabled := groupFields[11].Descriptor()
	// group.DefaultBurstModeHighUsageEnabled holds the default value on creation for the burst_mode_high_usage_enabled field.
	group.DefaultBurstModeHighUsageEnabled = groupDescBurstModeHighUsageEnabled.Default.(bool)
	// groupDescSecurityPolicyEnabled is the schema descriptor for security_policy_enabled field.
	groupDescSecurityPolicyEnabled := groupFields[12].Descriptor()
	...
	groupDescSecurityPolicyMode := groupFields[13].Descriptor()
	...
	groupDescSecurityPolicyEmailEnabled := groupFields[14].Descriptor()
	...
	// groupDescAntiDegradePreset is the schema descriptor for anti_degrade_preset field.
	groupDescAntiDegradePreset := groupFields[63].Descriptor()
	// group.DefaultAntiDegradePreset holds the default value on creation for the anti_degrade_preset field.
	group.DefaultAntiDegradePreset = groupDescAntiDegradePreset.Default.(string)
	// group.AntiDegradePresetValidator is a validator for the "anti_degrade_preset" field. It is called by the builders before save.
	group.AntiDegradePresetValidator = groupDescAntiDegradePreset.Validators[0].(func(string) error)

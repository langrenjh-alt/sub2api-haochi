...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "burst_mode_enabled", Type: field.TypeBool, Default: false},
		{Name: "burst_mode_threshold_percent", Type: field.TypeInt, Default: 90},
		{Name: "burst_mode_429_retry_count", Type: field.TypeInt, Default: 10},
		{Name: "burst_mode_high_usage_enabled", Type: field.TypeBool, Default: false},
		...
		{Name: "anti_degrade_preset", Type: field.TypeString, Size: 32, Default: ""},

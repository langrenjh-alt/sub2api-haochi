...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/WishTeam5X/', label: 'WishTeam5X', icon: SignalIcon },
    { path: '/admin/pool-runway', label: '号池续航', icon: SignalIcon },
    { path: '/admin/codex-turn-state', label: 'Codex 状态池', icon: SignalIcon },

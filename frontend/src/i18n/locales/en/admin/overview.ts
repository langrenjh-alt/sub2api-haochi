export default {
    ...
    groups: {
      ...
      form: {
        ...
        burstModeHint: 'Keeps cache affinity and concentrates traffic by ascending account ID. Disabled uses the default scheduler.',
        burstModeThreshold: 'Account concurrency threshold',
        burstModeThresholdHint: 'Fill new requests into accounts by ID up to this concurrency percentage. Remaining capacity is reserved for existing cache-affine requests.',
        burstModeThresholdRange: 'Account concurrency threshold must be an integer from 1 to 100',
        burstMode429RetryCount: '429 same-account retry count',
        burstMode429RetryCountHint: 'When burst mode is enabled, retry the same account this many times after a 429. Default: 10.',
        burstMode429RetryCountRange: '429 retry count must be an integer from 1 to 100',
        burstModeHighUsage: 'High-usage concentration',
        burstModeHighUsageHint: 'OpenAI only. Ignore cache affinity and prioritize accounts at 95% or more current usage. The concurrency threshold still applies.',
